...
const ControlWorkspaceButton = ({
	shareToken,
	controlledBy,
	currentUserId,
	isHost,
	onControlChanged,
}: ControlWorkspaceButtonProps) => {
	...
	return (
		<DropdownMenu.Root>
			...
			<DropdownMenu.Portal>
				...
				>
					{!hasControl && (
						<DropdownMenu.Item className={menuItemClass} onSelect={handleTakeControl}>
							Take Control
						</DropdownMenu.Item>
					)}
					{hasControl && !isHost && (
						<DropdownMenu.Item className={menuItemClass} onSelect={handleReturnControl}>
							Return Control
						</DropdownMenu.Item>
					)}
				</DropdownMenu.Content>
